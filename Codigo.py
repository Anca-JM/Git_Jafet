...
def verificar_password(password, salt, hash_guardado):
    ...
    return hashlib.compare_digest(hash_prueba, hash_guardado)
...
def main():
    ...
    password_registro = getpass("Crea una contraseña: ")
    password_confirmada = getpass("Confirma la contraseña: ")
